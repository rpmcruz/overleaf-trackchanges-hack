...
print('<p>Notice: &bull; Only the last 30 day changes are displayed. &bull; This information is updated every 5 minutes (page automatically refreshed). &bull; Last 48h of changes are in <span class="highlight">highlight</span>.</p>')
